...
def add_506_tag
  restrictions_apply = @record.aspace_record['restrictions'].to_s
  ...
  if restrictions_apply == 'false'
      ...
      restrictions_text = "Collection has restrictions on access and/or use. See finding aid linked below for more details."
